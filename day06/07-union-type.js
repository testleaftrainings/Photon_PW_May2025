...
function performActions(url, action) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 9:
                    _a.sent();
                    return [2 /*return*/, "The title of the page ".concat(title)];
...
function runTest() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, performActions("https://www.amazon.in", 'screenshot')];
                case 1:
                    screenshotResult = _a.sent();
                    console.log(screenshotResult);
                    return [4 /*yield*/, performActions("https://www.amazon.in", 'title')];
                case 2:
                    titleResult = _a.sent();
